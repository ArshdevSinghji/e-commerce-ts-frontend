    ...
    <div className={style.backdrop} onClick={onCancel}>
      <div className={style.dialog}>
        ...
        {interaction === "addToCart" ? (
          <p>
            Do you want to add <strong>{title}</strong> in your cart?
          </p>
        ) : (
          <p>
            Do you want to remove <strong>{title}</strong> in your cart?
          </p>
        )}
        <div className={style.buttons}>
          <button className="button_50" onClick={onCancel}>
            Cancel
          </button>
          <button className="button_50" onClick={onConfirm}>
            Confirm
          </button>
        </div>
      </div>
